...
const COMPLAINT_TEMPLATES = [
  (adj: string, topic: string, code: string) => `My order #${code} experienced ${adj} delays on ${topic}. Support agent was unhelpful and closed the ticket prematurely.`,
  ...
  (adj: string, topic: string, code: string) => `Huge shoutout to the engineering team for fixing ${topic}! Outstanding release (Ref #${code}). Service feels ${adj} and smooth now.`,
