...
export default async function AppLayout({
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-slate-950 overflow-hidden text-slate-900 dark:text-slate-100 font-sans transition-colors duration-300 print:h-auto print:overflow-visible print:bg-white print:text-slate-900">
      <Sidebar user={user} />
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto bg-slate-50 dark:bg-slate-950 relative transition-colors duration-300 print:overflow-visible print:bg-white print:p-0 print:block">
        ...
        <div className="flex-1 p-6 md:p-8 relative z-10 print:p-0">
          {children}
        </div>
      </main>
    </div>
